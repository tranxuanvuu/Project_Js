...
fetch('http://localhost:3000/list_products')
	...
	.then(products => {
		...
		khoiTao(); // Gọi hàm khoiTao sau khi dữ liệu đã được gán
	})
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Phone Store</a> - Designed by
            <span style="color: #eee; font-weight: bold">Trần Xuân Vũ</span></p>
    </div>`);
}
